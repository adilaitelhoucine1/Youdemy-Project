...
$AllEnseignants=$Enseignant->showallEnseignants();
//print_r($AllEnseignants);
...
<body class="bg-gray-50">
    <nav class="fixed w-full z-50 nav-blur">
        ...
        <div class="mobile md:hidden hidden bg-white border-t" id="mobile-menu">
    ...
    <div class="hero-pattern">
        <div class="max-w-7xl mx-auto py-16 px-4">
            ...
            <div class="max-w-7xl mx-auto px-4 py-12">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold mb-2 capitalize"><?php echo $teacher['nom'] ?></h3>
